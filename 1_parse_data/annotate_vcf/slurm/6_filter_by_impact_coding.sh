...
#SBATCH -o /data5/austin/work/UKB_oligo/UKB_Oligo/1_parse_data/annotate_vcf/slurm/logs/6_out.log
#SBATCH -e /data5/austin/work/UKB_oligo/UKB_Oligo/1_parse_data/annotate_vcf/slurm/logs/6_err.log
#SBATCH --ntasks=1
...
bash /data5/austin/work/UKB_oligo/UKB_Oligo/1_parse_data/annotate_vcf/src/6_filter_by_impact_coding.sh
