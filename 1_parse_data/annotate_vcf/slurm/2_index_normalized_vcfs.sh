...
#SBATCH -o /data5/austin/work/UKB_oligo/UKB_Oligo/1_parse_data/annotate_vcf/slurm/logs/2_out.log
#SBATCH -e /data5/austin/work/UKB_oligo/UKB_Oligo/1_parse_data/annotate_vcf/slurm/logs/2_err.log
#SBATCH --ntasks=1
...
python /data5/austin/work/UKB_oligo/UKB_Oligo/1_parse_data/annotate_vcf/src/2_index_normalized_vcfs.py
