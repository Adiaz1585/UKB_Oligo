...
#SBATCH -o /data5/austin/work/UKB_oligo/UKB_Oligo/1_parse_data/annotate_vcf/slurm/logs/1_out.log
#SBATCH -e /data5/austin/work/UKB_oligo/UKB_Oligo/1_parse_data/annotate_vcf/slurm/logs/1_err.log
#SBATCH --ntasks=1
...
python3 /data5/austin/work/UKB_oligo/UKB_Oligo/1_parse_data/annotate_vcf/src/1_split_leftnorm.py
